...
class ChallengeNameAdapter(private var challengeNameLIst: MutableList<String>, // 챌린지 목록을 저장하는 변수
...
): RecyclerView.Adapter<ChallengeNameAdapter.ChallengeViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ChallengeViewHolder, position: Int) {
        ...
        holder.itemView.findViewById<TextView>(R.id.challengeNameTextView).setOnClickListener {
